"use client";
import { Comment, Heart } from "@/app/assets/icons";
...
function Post() {
  return (
    <div className="border-1 border-foreground-200 rounded-2xl py-4 px-7 hover:scale-101 active:scale-100.005 duration-300 ease-in-out select-none">
