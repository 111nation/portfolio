...
function Hero() {
  return (
    <div className="bg-foreground-50 border-1 border-foreground-200 my-3 mx-0 sm:mx-4 lg:my-5 lg:mx-10 sm:rounded-xl px-4 sm:px-10 py-8 xl:py-20 xl:px-25 2xl:mx-auto relative block lg:m-auto max-w-350 overflow-hidden">
      <img
      ...
      <div>
        ...
        <img
          className="hidden sm:block sm:absolute -top-15 -right-15 lg:-top-15 xl:right-50 xl:top-0 2xl:right-40 2xl:top-0 max-w-200 w-[85%] z-1"
          src="/cutout.png"
          alt="A photo of me"
        />
      </div>
      ...
      <div className="flex flex-row justify-center sm:justify-start gap-4 sm:gap-2 z-2">
        <ClearButton className="px-7 py-1 sm:px-4">
          <p className="text-gradient text-xl sm:text-lg font-medium my-1">
            Portfolio
          </p>
        </ClearButton>

        <ClearButton className="px-4">
